...
// Function to generate a tip based on the category
function generateTip($pdf, $categoryId, $tipsArr)
{
    switch ($categoryId) {
        case 0:
...
// Function to get the index with the maximum value from an array
function getMaxIndexValue($sumArr)
{
    $temp = 0;
...
$conn = new mysqli($host, $db_user, $db_password, $db_name) or die("Error: " . $conn->errno);
...
// Array to store category-wise expenses
$sumArr = [];
...
// Array of tips for each category
$tipsArr = [
    [
